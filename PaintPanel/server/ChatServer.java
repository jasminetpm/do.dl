...
public class ChatServer
{
	...
	private LinkedList<ChatServerClientThread> clientList;
	private int port;
	...
	public ChatServer(int port)
	{
		...
		this.clientList = new LinkedList<ChatServerClientThread>();
	}
	...
	public void acceptClientLoop()
	{
		while (true)
		{
			...
			try {
				...
				ChatServerClientThread th = new ChatServerClientThread(c, this);
	...
	public LinkedList<ChatServerClientThread> getClientList()
	{
	...
	{
		ChatServer serv = new ChatServer(SetPort.port);
